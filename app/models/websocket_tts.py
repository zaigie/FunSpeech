...
class AliyunSubtitle(BaseModel):
    ...
    phoneme_list: List[Dict[str, Any]] = Field(default_factory=list, description="音素列表")
...
class AliyunWSMessage(BaseModel):
    ...
    payload: Optional[Union[AliyunStartSynthesisPayload, AliyunRunSynthesisPayload, AliyunSynthesisPayload]] = Field(None, description="消息负载")
